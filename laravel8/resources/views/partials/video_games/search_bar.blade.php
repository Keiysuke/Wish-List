<div id="search_bar" class="inline-flex border-2 rounded shadow">
    <div class="relative mx-auto text-gray-600 lg:block hidden w-full">
        <input type="text" class=" p-2 w-80 pr-8" placeholder="{{ __('Search video games...') }}" id="search_text" name="search_text" onKeyUp="search_video_games();" value="{{ $search }}">
    ...
    <div class="flex justify-center items-center border-l-2 w-full px-2 gap-1">
        ...
        <select class="text-sm border border-gray-300 rounded p-1 pr-5 bg-right" name="sort_by" id="sort_by" onChange="search_video_games();">
