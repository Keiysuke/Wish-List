...
<div class="{{ $class }} h-full w-full" onClick="toggle_thumbnail({{ $cpt }})">
    <div class="relative bg-orange-500 font-semibold uppercase rounded rounded-b-none text-white p-2">
        ...
        <div class="absolute right-2 top-2">
            ...
            <a onClick="simulate_benef({{ $payed }}, {{ $sold }});" title="Simuler le bénéfice" class="no-propagate inline-flex items-center text-sm font-medium text-white hover:text-black transition ease-in-out duration-150">
