...
--
-- Hôte : 127.0.0.1:3308
-- Généré le :  jeu. 11 mars 2021 à 11:36
...
CREATE TABLE IF NOT EXISTS `product_users` (
  ...
  KEY `product_users_product_website_id_foreign` (`product_website_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `purchases` (`id`, `product_id`, `product_state_id`, `website_id`, `cost`, `date`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, '49.00', '2017-05-19', '2021-03-05 10:47:32', '2021-03-05 10:47:32'),
(2, 4, 1, 5, '9.99', '2018-01-03', '2021-03-05 10:54:09', '2021-03-05 10:54:09'),
(3, 5, 1, 1, '19.84', '2018-06-18', '2021-03-05 11:00:33', '2021-03-05 11:00:33'),
(4, 6, 1, 1, '7.00', '2019-01-05', '2021-03-05 11:03:23', '2021-03-05 11:03:23'),
(5, 9, 1, 1, '11.95', '2017-01-01', '2021-03-05 11:11:05', '2021-03-05 11:11:05'),
(6, 12, 1, 5, '899.00', '2020-12-03', '2021-03-05 11:15:48', '2021-03-05 11:15:48'),
(7, 13, 1, 3, '89.00', '2019-06-10', '2021-03-05 11:18:13', '2021-03-05 11:18:13'),
(8, 9, 1, 8, '11.95', '2017-01-01', '2021-03-05 16:43:32', '2021-03-05 16:43:32');
...
INSERT INTO `sellings` (`id`, `product_id`, `product_state_id`, `purchase_id`, `website_id`, `sell_state_id`, `price`, `confirmed_price`, `shipping_fees`, `shipping_fees_payed`, `nb_views`, `date_begin`, `date_sold`, `date_send`, `box`, `created_at`, `updated_at`) VALUES
(1, 4, 1, 2, 2, 5, '8.00', '8.00', '7.95', '7.95', 18, '2018-08-06', '2018-08-14', '2018-08-15', 1, '2021-03-05 14:06:28', '2021-03-05 14:06:28'),
(2, 9, 1, 5, 2, 2, '10.00', NULL, '8.00', NULL, 155, '2020-03-20', NULL, NULL, 0, '2021-03-05 16:44:18', '2021-03-05 16:44:18');
...
('ekfaHySscyYmUec7jFNwYdeBw58bEPgj0f4zkJtP', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.190 Safari/537.36', '', 1615461806);
...
(1, 'Admin', 'admin@admin.fr', '2021-03-05 10:38:02', '$2y$10$AGB01hDZNr7VNiy6jKaCn.jcCLCvXvFBgyCHghQ41X6wjAF/CzV0.', NULL, NULL, '8C2NPSHAbpXmKpq6YdwJCCuvC4LEEe4TF55GREEh8PjJTChFi5XNkNniowji', NULL, NULL, '2021-03-05 10:37:47', '2021-03-05 10:38:02');
...
ALTER TABLE `product_users`
  ...
  ADD CONSTRAINT `product_users_product_website_id_foreign` FOREIGN KEY (`product_website_id`) REFERENCES `product_websites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
